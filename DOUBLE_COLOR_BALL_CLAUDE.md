...
2.任意一组的7个数值，能完全匹配dataList中的7个数值
...
1.尝试基于matrixItemList中的前序数据，预测后续数据，如果满足“算法匹配成功的约束”则输出算法说明。

2.尝试基于最近距离算法，给出预测算法，如果满足“算法匹配成功的约束”则输出算法说明。。

3.尝试基于随机算法，如果满足“算法匹配成功的约束”则输出算法说明。
4.其他思路
